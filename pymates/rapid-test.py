...
transformation0 = pymates.OCC.gp.gp_Trsf()
transformation0.SetTranslation(pymates.OCC.gp.gp_Pnt(0,0,0),pymates.OCC.gp.gp_Pnt(0,10,0))
btr = pymates.OCC.BRepBuilderAPI.BRepBuilderAPI_Transform(transformation0)
